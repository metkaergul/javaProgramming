...
public class PolymorphismIntro {
    public static void main(String[] args) {
        ...
        Employee tester = new Tester("Ali",'M',30,4243,"SDET",145000.00);
        Employee developer = new Developer("Alex",'M',23,3256,"Web Developer",155000.00);
        Employee teacher = new Teacher("Angel",'F',34,2267,"English Teacher",85000.00);
        Employee driver = new Driver("Jhon",'M',43,4234,"Lyft Driver",75000.00);
        ...
        Employee employee = new Tester("Ali",'M',30,42,"SDET",145000.00);
        employee.work();
        // employee.bugReport();
        ...
        Animal animal3 = new Cat("Max", 'M', 43, "SMALL",  "White");
