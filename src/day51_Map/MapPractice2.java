...
public class MapPractice2 {
    public static void main(String[] args) {
       ...
       /* System.out.println("____________________________________");
        for (Map.Entry<String, Integer> eacPair : map.entrySet()) {
            Integer currentSlary= eacPair.getValue();
            if(eacPair.getValue()<120000){
                map.replace(eacPair.getKey(), eacPair.getValue()+10000);
            }
        }
        System.out.println(map);*/
