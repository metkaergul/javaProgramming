...
*/
        ...
        System.out.println("--------------------------------------------------------");
         ...
         /*  //find the min and max value of students score
        Integer tempMAX = students.get("Aygun");


        for (Integer eachValue : students.values()) {
            if(eachValue>tempMAX){
                tempMAX=eachValue;
            }
        ...
        Set<Integer>setr=new TreeSet<>( students.values());
        System.out.println(setr);
        List<Integer>list=new ArrayList<>(setr);
